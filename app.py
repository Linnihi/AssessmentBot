...
import os
from prompts import SYSTEM_ROLE, INITIAL_CONVERSATION
...
# Initialize session state for chat input placeholder
if "chat_input_placeholder" not in st.session_state:
    st.session_state.chat_input_placeholder = "Type your response here..."
...
with st.sidebar:
    ...
    uploaded_files = st.file_uploader(
        "Upload any relevant documents to provide context for the assessment.",
        type=["pdf", "docx"],
...
if prompt := st.chat_input("Type your response here..."):
    ...
    if st.session_state.knowledge_base:
        context = f"Based on the following knowledge:\n{st.session_state.knowledge_base}\n\nUser question: {prompt}"
    else:
        context = prompt
